...
internal static class InputEventExtensions
{
    ...
    internal static bool IsButtonEventSource(this InputSourceType sourceType) => sourceType.HasFlag(InputSourceType.Gamepad) || sourceType.HasFlag(InputSourceType.Dpad);
    ...
    internal static bool IsAxisEventSource(this InputSourceType sourceType) => sourceType.HasFlag(InputSourceType.Joystick) || sourceType.HasFlag(InputSourceType.Dpad);
}

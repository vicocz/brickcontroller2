...
public class CaDARaceCarRev2Tests
{
    ...
    public void TryGetTelegram_ZeroValuesAndIosPlatform_ReturnsProperDatagram()
    {
        ...
        {
            0xC0, 0x3D, 0xCA, 0x66, 0x6D, 0x32, 0xB2, 0x9E,
            0xD2, 0x57, 0xA1, 0xB5, 0xF6, 0x66 // other bytes are random and can differ, but the first 13 bytes should be consistent

            // CADA SMart
            //0xC0, 0x00, 0xBB, 0x11, 0x11, 0x20, 0xB9, 0x88,
            //0x51, 0x76, 0x76, 0x00, 0xF6, 0xA1, 0xCC, 0xB8,

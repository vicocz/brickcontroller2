...
public class RaceCarMessageEncoderRev2Tests
{
    ...
    public void Encode_Connect_ReturnsProperPayload(ushort deviceId, ushort appId,
        byte v1, byte v2, byte v4)
    {
        ...
        // act
        var result = encoder.Encode([Zero, Zero, Zero], true);
    ...
    public void Encode_WithZeroValues_ReturnsProperPayload(ushort deviceId, ushort appId,
        byte v1, byte v2, byte v4)
    {
        // arrange
        var encoder = Create(deviceId, appId);
        ...
        // act
        var result = encoder.Encode([Zero, Zero, Zero], false);
    ...
    public void Encode_WithZeroValuesAndLightOn_ReturnsProperPayload(ushort deviceId, ushort appId,
        byte v1, byte v2, byte v4)
    {
        // arrange
        var encoder = Create(deviceId, appId);
    ...
    public void Encode_WithPartialSteeringAndLightOn_ReturnsProperPayload(ushort deviceId, ushort appId,
        float value, byte v1, byte v2, byte v4, byte sequence)
    {
        ...
        // act
        var result = encoder.Encode([Zero, (Half)value, One]);
    ...
    public void Encode_WithPartialSpeedAndLightOn_ReturnsProperPayload(ushort deviceId, ushort appId,
        float value, byte v1, byte v2, byte v4, byte sequence)
    {
        // arrange
        var encoder = Create(deviceId, appId, sequence: (byte)(sequence - 1));
        ...
        // act
        var result = encoder.Encode([(Half)value, Zero, One]);
    ...
    public void Encode_WithMiddleFirstChannel_ReturnsProperPayload(ushort deviceId, ushort appId,
        float value, byte v1, byte v2, byte v4, byte sequence)
    {
        // arrange
        var encoder = Create(deviceId, appId, sequence: (byte)(sequence - 1));
        ...
        // act
        var result = encoder.Encode([(Half)value, Zero, Zero]);

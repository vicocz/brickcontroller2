...
public sealed class PowerBoxMBatteryDatagramTests : PowerBoxDatagramTestsBase
{
    ...
    [Theory]
    [InlineData(new float[] { 0.0f }, new byte[] { PayloadIdentifierCommand1, AppIdentifier1, AppIdentifier2, 0x00, 0x00, 0x00, 0x00, PayloadIdentifierCommand2 })]      // all channels neutral
    [InlineData(new float[] { 1.0f }, new byte[] { PayloadIdentifierCommand1, AppIdentifier1, AppIdentifier2, 0xf7, 0xf7, 0x00, 0x00, PayloadIdentifierCommand2 })]      // channel 1 maximum, others neutral
    [InlineData(new float[] { -1.0f }, new byte[] { PayloadIdentifierCommand1, AppIdentifier1, AppIdentifier2, 0x7f, 0x7f, 0x00, 0x00, PayloadIdentifierCommand2 })]     // channel 1 minimum, others neutral
    [InlineData(new float[] { 9.0f }, new byte[] { PayloadIdentifierCommand1, AppIdentifier1, AppIdentifier2, 0xf7, 0xf7, 0x00, 0x00, PayloadIdentifierCommand2 })]     // all channels above maximum, should be clamped to maximum

...
public class JieStarPlatformService : IJieStarPlatformService
{
    ...
    public bool TryGetRfPayload(byte[] rawData, out byte[] rfPayload)
    {
        ...
        int payloadLength = CryptTools.GetRfPayload(JieStarProtocol.SeedArray, JieStarProtocol.HeaderArray, rawData, HeaderOffset, JieStarProtocol.CTXValue1, JieStarProtocol.CTXValue2, rfPayload, PayloadOffset);

...
internal class MK3_8 : MKBaseNibble, IDeviceType<MK3_8>
{
    ...
    public MK3_8(string name, string address, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IMKPlatformService mkPlatformService, IMouldKingDeviceManager mkDeviceManager)
      : base(name, address, deviceRepository, bleService, mkPlatformService, mkDeviceManager, 0, Telegram_Connect, Telegram_Base)
    {

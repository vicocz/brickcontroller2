...
internal class MK5 : MKBaseNibble, IDeviceType<MK5>
{
    ...
    public MK5(string name, string address, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IMKPlatformService mkPlatformService, IMouldKingDeviceManager mkDeviceManager)

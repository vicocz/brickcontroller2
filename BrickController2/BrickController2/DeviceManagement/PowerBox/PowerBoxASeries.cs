...
internal class PowerBoxASeries : PowerBoxBaseNibble, IDeviceType<PowerBoxASeries>
{
    ...
    public PowerBoxASeries(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IPowerBoxPlatformService powerboxPlatformService, PowerBoxDeviceManager powerboxDeviceManager)

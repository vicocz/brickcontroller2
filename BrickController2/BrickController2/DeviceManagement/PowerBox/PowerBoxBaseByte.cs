...
internal abstract class PowerBoxBaseByte : BluetoothAdvertisingDevice
{
    ...
    protected PowerBoxBaseByte(string name, string address, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IPowerBoxPlatformService powerboxPlatformService, IPowerBoxDeviceManager powerboxDeviceManager, ReadOnlySpan<byte> telegram_Connect, ReadOnlySpan<byte> telegram_Base)

...
/// PowerBox baseclass
/// </summary>
internal abstract class PowerBoxBaseNibble : BluetoothAdvertisingDevice
{
    /// <summary>
    ...
    protected PowerBoxBaseNibble(string name, string address, byte[] deviceData, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IPowerBoxPlatformService powerboxPlatformService, PowerBoxDeviceManager powerboxDeviceManager, byte[] telegram_Connect, byte[] telegram_Base)
    ...
    /// <summary>
    /// Calculates the target position of a channel
    /// </summary>

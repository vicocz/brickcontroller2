...
internal class PowerBoxMBattery : PowerBoxBaseByte, IDeviceType<PowerBoxMBattery>
{
    ...
    public PowerBoxMBattery(string name, string address, IDeviceRepository deviceRepository, IBluetoothLEService bleService, IPowerBoxPlatformService powerboxPlatformService, IPowerBoxDeviceManager powerboxDeviceManager)
      : base(name, address, deviceRepository, bleService, powerboxPlatformService, powerboxDeviceManager, Telegram_Connect_Device, Telegram_Base_Device)
    {
    }

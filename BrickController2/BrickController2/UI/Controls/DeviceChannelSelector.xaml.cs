...
namespace BrickController2.UI.Controls
{
    ...
    public partial class DeviceChannelSelector : ContentView
    {
        public DeviceChannelSelector()
        {
            ...
            SBrickLightChannelA1.Command = new SafeCommand(() => SelectedChannel = 0);
            SBrickLightChannelA2.Command = new SafeCommand(() => SelectedChannel = 1);
            SBrickLightChannelA3.Command = new SafeCommand(() => SelectedChannel = 2);
            SBrickLightChannelB1.Command = new SafeCommand(() => SelectedChannel = 3);
            SBrickLightChannelB2.Command = new SafeCommand(() => SelectedChannel = 4);
            SBrickLightChannelB3.Command = new SafeCommand(() => SelectedChannel = 5);
            SBrickLightChannelC1.Command = new SafeCommand(() => SelectedChannel = 6);
            SBrickLightChannelC2.Command = new SafeCommand(() => SelectedChannel = 7);
            SBrickLightChannelC3.Command = new SafeCommand(() => SelectedChannel = 8);
            SBrickLightChannelD1.Command = new SafeCommand(() => SelectedChannel = 9);
            SBrickLightChannelD2.Command = new SafeCommand(() => SelectedChannel = 10);
            SBrickLightChannelD3.Command = new SafeCommand(() => SelectedChannel = 11);
            SBrickLightChannelE1.Command = new SafeCommand(() => SelectedChannel = 12);
            SBrickLightChannelE2.Command = new SafeCommand(() => SelectedChannel = 13);
            SBrickLightChannelE3.Command = new SafeCommand(() => SelectedChannel = 14);
            SBrickLightChannelF1.Command = new SafeCommand(() => SelectedChannel = 15);
            SBrickLightChannelF2.Command = new SafeCommand(() => SelectedChannel = 16);
            SBrickLightChannelF3.Command = new SafeCommand(() => SelectedChannel = 17);
            SBrickLightChannelG1.Command = new SafeCommand(() => SelectedChannel = 18);
            SBrickLightChannelG2.Command = new SafeCommand(() => SelectedChannel = 19);
            SBrickLightChannelG3.Command = new SafeCommand(() => SelectedChannel = 20);
            SBrickLightChannelH1.Command = new SafeCommand(() => SelectedChannel = 21);
            SBrickLightChannelH2.Command = new SafeCommand(() => SelectedChannel = 22);
            SBrickLightChannelH3.Command = new SafeCommand(() => SelectedChannel = 23);
        ...
        private static void OnDeviceChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is DeviceChannelSelector dcs && newValue is Device device)
            {
                ...
                dcs.SbrickLightSection.IsVisible = deviceType == DeviceType.SBrickLight;

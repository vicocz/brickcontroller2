...
namespace BrickController2.UI.ViewModels
{
    public class CreationListPageViewModel : PageViewModelBase
    {
            ...
            : base(navigationService, translationService)
        {
            ...
            NavigateToBlockTesterCommand = new SafeCommand(async () => await NavigationService.NavigateToAsync<BlocksTesterPageViewModel>());
        ...
        public ICommand NavigateToBlockTesterCommand { get; }

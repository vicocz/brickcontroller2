...
namespace BrickController2.UI.ViewModels
{
    public class CreationListPageViewModel : PageViewModelBase
    {
            ...
            : base(navigationService, translationService)
        {
            ...
            NavigateToCameraSetupCommand = new SafeCommand(async () => await NavigationService.NavigateToAsync<CameraSetupPageViewModel>());
        ...
        public ICommand NavigateToCameraSetupCommand { get; }
